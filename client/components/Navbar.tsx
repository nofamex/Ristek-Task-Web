...
const RoundedMenu = tw`w-14 h-14 rounded-full bg-primary absolute bottom-6 flex justify-center items-center right-6 fixed md:hidden`;
...
const LongMenuButtonContainer = tw.div`flex w-full p-4`;
const ButtonLogoOut = tw.div`w-9 h-9 rounded-full bg-white flex justify-center items-center`;
const ButtonLogoIn = tw.div`w-7 h-7 rounded-full bg-primary`;
