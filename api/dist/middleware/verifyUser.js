    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (!user) {
                    res.send(ServiceError_1.NoUserFoundError());
                    return [2 /*return*/];
                }
                samePassword = user.password === req.body.data.password;
                if (!samePassword) {
                    res.send(ServiceError_1.WrongPasswordError());
                    return [2 /*return*/];
                }
                next();
                return [2 /*return*/];
