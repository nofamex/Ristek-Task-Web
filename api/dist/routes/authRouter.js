...
authRouter.post('/register', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, fullName, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, username = _a.username, password = _a.password, fullName = _a.fullName;
                return [4 /*yield*/, authService.createNewUser({
                        username: username,
                        password: password,
                        fullName: fullName,
                    })];
